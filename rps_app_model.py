...
train_dir = os.path.join('E:\\Documents\\Niranjan\\questions\\qure.ai\\e0\strmlt\\extras\\data\\rps\\rps\\')
test_dir = os.path.join('E:\\Documents\\Niranjan\\questions\\qure.ai\\e0\\strmlt\\extras\\data\\rps-test-set\\rps-test-set\\')
